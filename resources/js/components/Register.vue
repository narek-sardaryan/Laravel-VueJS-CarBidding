                ...
                <div class="row">
                    <div class="col">
                        ...
                        <div class="row register_request_row">
                            <div class="col-md-3">
                                <button class="register_request_btn active_register_btn btn-ripple" id="role_buyer">Хочу покупать ТС</button>
                            </div>
                            <div class="col-md-3">
                                <button  class="register_request_btn btn-ripple" id="role_seller">Хочу оценивать и продавать ТС</button>
                            </div>
                        </div>
                        <div class="row register_area buyer">
